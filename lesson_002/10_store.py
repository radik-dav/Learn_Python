...
tables_prices_1 = tables_item_1['price']
tables_prices_2 = tables_item_2['price']
tables_cost_1 = tables_quantity_1 * tables_prices_1
tables_cost_2 = tables_quantity_2 * tables_prices_2
...
sofas_prices_1 = sofas_item_1['price']
sofas_prices_2 = sofas_item_2['price']
sofas_cost_1 = sofas_quantity_1 * sofas_prices_1
sofas_cost_2 = sofas_quantity_2 * sofas_prices_2
...
chairs_prices_1 = chairs_item_1['price']
chairs_prices_2 = chairs_item_2['price']
chairs_prices_3 = chairs_item_3['price']

chairs_cost_1 = chairs_quantity_1 * chairs_prices_1
chairs_cost_2 = chairs_quantity_2 * chairs_prices_2
chairs_cost_3 = chairs_quantity_3 * chairs_prices_3
...
print('Диваны -', sofas_quantity, 'шт, стоимость', sofas_cost, 'руб')
print('Стулья -', chairs_quantity , 'шт, стоимость', chairs_cost, 'руб')
